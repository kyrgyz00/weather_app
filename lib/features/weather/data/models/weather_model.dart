...
//
//     final CityWeatherModel = CityWeatherModelFromJson(jsonString);
...
class CityWeatherModel {
  ...
  factory CityWeatherModel.fromRawJson(String str) =>
...
class Main {
  ...
  factory Main.fromJson(Map<String, dynamic> json) => Main(
        ...
        pressure: json["pressure"]!= null ?json["pressure"].toInt():0 ,
        humidity: json["humidity"]!= null ?json["humidity"].toInt():0,
        seaLevel: json["sea_level"] != null ?json["sea_level"].toInt():0,
        grndLevel: json["grnd_level"]!= null ?json["grnd_level"].toInt():0,
      );
...
class Weather {
  ...
  factory Weather.fromJson(Map<String, dynamic> json) => Weather(
        ...
        icon: convertIconsToEnum(json["icon"]),
      );
